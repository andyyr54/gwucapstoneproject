...
<?php include 'navbar.html'; ?>
    <div class="container">
        <?php
          ...
          {
            ?>
        <h2>Viewing Hold Details! for StudentID - <?php echo $userid ?></h2>
        <table>
            <tr>
            <th>Hold ID</th>
            <th>User ID</th>
        ...
        <?php
            ...
            $sql_hold = "SELECT * FROM student_hold where studentid='$userid'";
    ...
    {
        ?>
<h2>There is no Hold for the StudentID - <?php echo $userid ?></h2>
<td><a href="<?php echo $addstudenttohold ?>"><button type="button" >Add New hold to Student </button></a></td>
        <?php
    }
    ?>
    </div>
