...
<body>
    <div class="container">
        <h2>Viewing/Changing Details for Major/Minor</h2>
    <?php
...
<?php
        ...
        ?>
        <hr><hr>
        <h3>Select Below Major for student</h3>
        <!-- Fetching All the available Major and Minor -->
        <select id="major" name="major">
        <?php
           $sql_major_all = "SELECT * FROM major order by major_name ASC ";
    ...
    <h3>Select Below Minor for student</h3>
        <!-- Fetching All the available Major and Minor -->
