...
<?php include 'navbar.html'; ?>
    <div class="container">
        ...
        <table>
            ...
            <th>User ID</th>
                ...
                <th>Assign/View Student to Course Section according to Semester!</th>
            </tr>
        <?php
            ...
            while($det_studentdetails = mysqli_fetch_assoc($result_studentdetails)){
                ...
                $link="selectsemesterforstudentassign.php?studentid=".$userid;
    ...
    ?>
            ...
            <tr>
                ...
                <td><a href="<?php echo $link ?>"><button type="button" >Enroll/View Student's Course Section according to Semester</button></a></td>
            </tr>
           <?php
