...
<?php
    ...
    <div class="container">
        ...
        <h2>Viewing/Changing Details for Major/Minor. Student is studying <?php echo $final_student_type?></h2>
    <?php
...
<?php
    ...
    <div class="container">
        ...
        <h2>Viewing/Changing Details for Major. Student is studying <?php echo $final_student_type?></h2>
    <?php
      $sql=mysqli_query($conn,"SELECT * FROM login where userid='$userid'");
      $row  = mysqli_fetch_array($sql);
      $sql1=mysqli_query($conn,"SELECT * FROM user where userid='$userid'");
