...
<?php include 'navbar.html'; ?>
    <div class="container">
        <h2>View Student - Transcript Details</h2>
        <table>
            <tr>
            <th>User ID</th>
                <th>First Name</th>
                ...
                <th>View Transcript of the student</th>
            </tr>
        <?php
            ...
            while($det_studentdetails = mysqli_fetch_assoc($result_studentdetails)){
                ...
                $link="viewtranscriptsummary.php?studentid=".$userid;
    ...
    ?>
            ...
            <tr>
                ...
                <td><a href="<?php echo $link ?>"><button type="button" >Update Grade/View Transcript of the student</button></a></td>
            </tr>
           <?php
