...
<?php include 'navbar.html'; ?>
    <div class="container">
        <h2>View Stats Office Details</h2>
        <table>
            <tr>
            <th>User ID</th>
                <th>First Name</th>
        ...
        <?php
            ...
            $sql_studentdetails = "SELECT * FROM user where user_type='Stats Office' ORDER BY first_name ASC, last_name ASC";
            ...
            while($det_studentdetails = mysqli_fetch_assoc($result_studentdetails)){
                ...
                $link="updatestatsofficedetails.php?userid=".$userid;
