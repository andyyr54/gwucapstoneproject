...
session_start();
     ...
     $linktoassignstudenttocoursesection="enrolltocoursesection.php?studentid=".$userid."&semesterid=".$semesterid;
...
<?php include 'navbar.html'; ?>
    <div class="container">
    <h2>Viewing Semester Schedule For Semester - <?php echo $semesterid ?> </h2>
        <table>
            <tr>
            <th>CRN</th>
            <th>CourseID</th>
...
//to mock
// $semester_end_date = '12/27/2023';
$restrict_withdraw="NO";
...
if ($date === false) {
    ...
    // Check if it's less than 1 month
    if ($months_left < 1) {
        // echo "Less than 1 month";
        $restrict_withdraw="YES";
    }
}
...
$row_course= mysqli_fetch_array($sql_course);
 ...
 $timeslotid=$row_course_section_exists_for_particular_semester["timeslotid"];
            ...
            {
                ?>
                <td><a href=""><button type="button" >Can't Drop/Withdraw as the semester end date is less than 1 month.</button></a></td>
                <?php
            }
            ?>
          <?php
       ...
       <br><br>
        ...
        <?php
 if($semesterid=="FALL2023")
 {
?>
        <center><a href=""><button type="button" >Cannot Enroll as Semester - <?php echo $semesterid ?> is an Ongoing one !</button></a></center>
...
<?php
 ...
 if(strtoupper($student_type_full_or_part_time)=="FULL TIME")
 {
    ...
    {
        ?>
        <center><a href="<?php echo $linktoassignstudenttocoursesection; ?>"><button type="button" >CLICK HERE TO Enroll to Course Section -  Semester - <?php echo $semesterid ?></button></a></center>
        <?php
       }
       else
       {
           ?>
        <center><a href=""><button type="button" >Cannot Enroll as you are FULL TIME and Already having 12 credits of classes for Semester - <?php echo $semesterid ?></button></a></center>
        <?php
       }
    }
    if(strtoupper($student_type_full_or_part_time)=="PART TIME"){
        ...
        {
            ?>
            <center><a href="<?php echo $linktoassignstudenttocoursesection; ?>"><button type="button" >CLICK HERE TO Enroll to Course Section</button></a></center>
            <?php
           }
           else
           {
               ?>
            <center><a href=""><button type="button" >Cannot Enroll as you are PART TIME and Already having 4 credits of classes for Semester - <?php echo $semesterid ?></button></a></center>
            <?php
           }
        }
    }
