...
// }
    ...
    <label for="name">CRN Will be AutoAssigned</label>
...
<h3>Select Below Course to assign CourseID for Course Section</h3>
    ...
    ?>  </select><br><br>
       <h3>Select Below Faculty to assign FacultyID for Course Section</h3>
        ...
        <?php
           $sql_faculty = "SELECT * FROM faculty order by facultyid ASC; ";
           ...
           while($det_faculty = mysqli_fetch_assoc($result_faculty)){
            ...
            $sql_faculty_name=mysqli_query($conn,"SELECT * FROM user where userid='$facultyid'");
                ...
                $sql_faculty_department = "SELECT * FROM faculty_department where facultyid='$facultyid'; ";
                ...
                while($det_faculty_department = mysqli_fetch_assoc($result_faculty_department)){
                        $faculty_department=$faculty_department."- ".$det_faculty_department['departmentid'];
                }
               
            echo '<option value="'.$det_faculty["facultyid"].'">'.$det_faculty["facultyid"]." -  ".$faculty_first_name." ".$faculty_last_name." ".$faculty_department.'</option>';
