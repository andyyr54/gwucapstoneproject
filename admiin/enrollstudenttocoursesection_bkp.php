...
<h3>Select Below Course to assign CourseID for Course Section</h3>
        ...
        <?php
         $sql_course = "SELECT * FROM course where departmentid='$major_departmentid' ";
...
<label for="name">Semester ID </label>
    ...
    <br><br>
        ...
        <input type="date" id="date_of_enrollment" name="date_of_enrollment" value="" required="required">
    ...
    <a class="link" href="addstudenttocoursesection.php"><button >Cancel</button></a>
    </div>
    <!-- <script>
