...
<?php include 'navbar.html'; ?>
    <div class="container">
        ...
        <h2>Viewing Student Details who were ABSENT for class</h2>
        <table>
            <tr>
            <th>Student ID</th>
        ...
        <?php
            ...
            while($det_enrollment = mysqli_fetch_assoc($row_enrollment)){
                ...
                $sql_attendance=mysqli_query($conn,"SELECT * FROM attendance where crn='$crn' AND attendance_date='$attendance_date' AND studentid='$studentid'");
                $row_attendance = mysqli_fetch_array($sql_attendance);
                if(!is_array($row_attendance))
                {
    ...
    ?>
        ...
        <div class="container">
        <!-- absenties -->
        <h2>Viewing Attendance Details of Student attended (PRESENT) for class</h2>
        <table>
            <tr>
            <th>Student ID</th>
                <th>Student First Name</th>
